...
namespace Waveform.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // Let user sign in with either email or username
                var user = (Input.Username).Contains("@") ? _userManager.FindByEmailAsync(Input.Username).Result.UserName : Input.Username;
